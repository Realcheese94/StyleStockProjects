...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Glide.with(context).load(myItem.getImgTest()).into(iv_img);
        //Glide.with(context).load(R.drawable.logotransparent).into(iv_img);
    ...
    public void addItem(Drawable img,String name,String contents,String imgtest)
    {
        MyItem myItem = new MyItem();
        myItem.setIcon(img);
        myItem.setName(name);
        myItem.setContents(contents);
        myItem.setImgTest(imgtest);
