...
public class ViewItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemcatagory.setSelection(select_category(catagory));
    ...
    public int select_category(String catagory){
        if(catagory.equals("TOP")) return 0;
        else if(catagory.equals("BOTTOM"))return 1;
        else if(catagory.equals("ACC")) return 2;
        else if(catagory.equals("SHOES")) return 3;
        else return 4;
    }
}